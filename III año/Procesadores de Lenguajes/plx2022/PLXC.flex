...
int                                                     { return new Symbol(sym.INTTYPE,0); }
char                                                    { return new Symbol(sym.CHARTYPE,1); }
float                                                   { return new Symbol(sym.FLOATTYPE,2); }
set                                                     { return new Symbol(sym.SET); }

[a-zA-Z][a-zA-Z0-9]*                                  { return new Symbol(sym.IDENT, yytext() ); }
\'[a-zA-Z0-9]*\'                                      { return new Symbol(sym.CHAR, String.valueOf((int) yytext().charAt(1))); }
(0|[1-9][0-9]*)                                       |
