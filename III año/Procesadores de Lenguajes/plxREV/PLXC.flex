...
int                                                     { return new Symbol(sym.INT,0); }
char                                                    { return new Symbol(sym.CHAR,1); }
float                                                   { return new Symbol(sym.FLOAT,2); }
set                                                     { return new Symbol(sym.SET); }

[a-zA-Z][a-zA-Z0-9]*                                  { return new Symbol(sym.IDENT, yytext() ); }
\'[a-zA-Z0-9]*\'                                      { return new Symbol(sym.TEXTO, yytext().substring(1, yytext().length()-1)); }
(0|[1-9][0-9]*)                                       |
