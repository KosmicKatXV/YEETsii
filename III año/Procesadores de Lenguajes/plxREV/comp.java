...
public class comp {
    ...
    public static void setLen(String id,String length){
    ...
    public static String asig(String id, String[] e){
        ...
        for(int i = 0; i < e.length ; i++){
            if(typeof.get(id) != 5 && e[i].contains("."))   error();
            int j = e[i].charAt(0);
            tmp = (typeof.get(id) == 4) ? String.valueOf(j) : e[i];
            System.out.println("    "+id+"["+i+"] = "+tmp+";");
        }
    ...
    private static void error() {
        System.out.println("  # ERROR: Error de tipos;");
